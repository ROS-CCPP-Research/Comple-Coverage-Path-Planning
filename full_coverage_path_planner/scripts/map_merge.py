...
class MultiMapMergerNode:
    def __init__(self):
        self._robot_map_topic = rospy.get_param("~robot_map_topic", "coverage_grid")
        self._robot_ns = rospy.get_param("~robot_namespace", "robot")
        self._merged_map_topic = rospy.get_param("~merged_map_topic", "coverage_grid_merged")
